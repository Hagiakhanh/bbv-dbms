...
public class TableTests
{
    ...
    public void DropColumn_ShouldReject_WhenReferencedByConstraint()
    {
        ...
        var pk = new PrimaryKey("PK", new List<Column> { col }, new Mock<Index>().Object, new Mock<IRowKeyExtractor>().Object);
    ...
    {
        var constraint = new PrimaryKey("PK", new List<Column> { new Column { Name = "Id" } }, new Mock<Index>().Object, new Mock<IRowKeyExtractor>().Object);
    ...
    {
        var constraint = new PrimaryKey("PK", new List<Column>(), new Mock<Index>().Object, new Mock<IRowKeyExtractor>().Object);
        _table.AddConstraint(constraint);
